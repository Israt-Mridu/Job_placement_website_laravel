        ...
        <div class="container">
            ...
            <div class="category-job-list-actiive owl-carousel">
                <div class="category-item">
                    <div class="img-icon">
                        <img src="{{asset('frontEndAssets')}}/images/icons/cat1.png" alt="">
                    </div>
                ...
                <div class="category-item">
                    <div class="img-icon">
                        <img src="{{asset('frontEndAssets')}}/images/icons/cat2.png" alt="">
                    </div>
                    <h5>Travel & Agency </h5>
                    <h6>(10 Jobs)</h6>
                </div>
                <div class="category-item">
                    <div class="img-icon">
                        <img src="{{asset('frontEndAssets')}}/images/icons/cat3.png" alt="">
                    </div>
                ...
                <div class="category-item">
                    <div class="img-icon">
                        <img src="{{asset('frontEndAssets')}}/images/icons/cat4.png" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row work-shap">
                <div class="col-md-4">
                    <div class="work-item">
                        <div class="img-icon">
                            <img src="{{asset('frontEndAssets')}}/images/icons/wrk1.png" alt="">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="work-item">
                        <div class="img-icon">
                            <img src="{{asset('frontEndAssets')}}/images/icons/wrk2.png" alt="">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="work-item">
                        <div class="img-icon">
                            <img src="{{asset('frontEndAssets')}}/images/icons/wrk3.png" alt="">
                        </div>
            ...
            <div class="blog-carousel carousel-style-two">
                ...
                <div class="single-blog hover-effect">
                    <div class="blog-image box-hover">
                        <a href="#" class="block">
                            <img src="{{asset('frontEndAssets')}}/images/blog/1.jpg" alt="">
                        </a>
                    </div>
                    <div class="blog-text">
                ...
                <div class="single-blog hover-effect">
                    <div class="blog-image box-hover">
                        <a href="#" class="block">
                            <img src="{{asset('frontEndAssets')}}/images/blog/2.jpg" alt="">
                        </a>
                    </div>
                    <div class="blog-text">
                        <h4><a href="blog-details.html">Standard blog post.</a></h4>
                ...
                <div class="single-blog hover-effect">
                    <div class="blog-image box-hover">
                        <a href="#" class="block">
                            <img src="{{asset('frontEndAssets')}}/images/blog/3.jpg" alt="">
                        </a>
                    </div>
                    <div class="blog-text">
                        <h4><a href="blog-details.html">Standard blog post.</a></h4>
